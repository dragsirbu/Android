package com.example.memeapp.Fragments;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("memes");
        return fragmentView;
    }
    ...
    public void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot memeSnap: dataSnapshot.getChildren()) {
                    Meme meme = memeSnap.getValue(Meme.class);
                    memes.add(meme) ;
                }

                memeAdapter = new MemeAdapter(getActivity(),memes);
